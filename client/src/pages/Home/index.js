    ...
    return (
        <main className='mt-20'>
            <div className="flex-col text-center flex justify-center">
                <img className='mx-auto mt-20 mb-12' src="https://via.placeholder.com/300" alt='ASSETWORX Company Logo' height={300} width={300}></img>
                ...
                <Link
                    type="button"
                    className="hover:bg-white hover:text-black inline-block mx-auto rounded-full border-2 border-primary px-6 pt-2 pb-[6px] font-medium uppercase text-white my-7"
                    style={{width:"200px",}}
                    >
                    Get Started
                </Link>
