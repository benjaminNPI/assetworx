...
const Contact = () => {
    ...
    `
    return (
        <div className='bg-gradient-to-r from-lightblue to-darkblue lg:px-32 py-10'>
            <div className='text-center font-bold text-3xl text-white'>Contact Us</div>
            <div className='lg:w-1/4 m-auto mb-10 text-center text-xl text-white'>Please reach out to us with any questions or concerns. We appreaciate all feedback and look forward to doing business with you!</div>
